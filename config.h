...
static const Rule rules[] = {
        ...
        */
        ...
        {"obs",     NULL,     NULL,              1 << 8,            0,          0,          0,      -1,         0},
        {"chromium",     NULL,     NULL,              1 << 8,            0,          0,          0,      -1,         0},
        {TERMCLASS, NULL,     NULL,              0,                 0,          1,          0,      -1,         0},
        {TERMCLASS, "cava",   NULL,              0,                 1,          1,          0,      -1,         1},
        {NULL,      NULL,     "Event Tester",    0,                 0,          0,          1,      -1,         0},
        {TERMCLASS, "bg",     NULL,              1 << 7,            0,          1,          0,      -1,         0},
...
static Key keys[] = {
        ...
        {MODKEY, XK_n, spawn, {.v = (const char *[]) {"neovide", NULL}}},
        ...
        {MODKEY, XK_Insert, spawn,
                SHCMD("xdotool type $(grep -v '^#' ~/.local/share/larbs/snippets | dmenu -i -l 50 | cut -d' ' -f1)")},
        ...
        {MODKEY, XK_F11, spawn,
                SHCMD("mpv --untimed --no-cache --no-osc --no-input-default-bindings --profile=low-latency --input-conf=/dev/null --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)")},
        ...
        {ShiftMask, XK_Home, spawn, {.v = (const char *[]) {"ffclip", NULL}}},
